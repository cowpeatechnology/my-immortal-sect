...
```
claude mcp add --transport http cocos-creator http://127.0.0.1:9527/mcp (use your configured port number)
```
...
2. Configure settings:
   - **Port**: HTTP server port (default: 9527)
...
The server exposes an HTTP endpoint at `http://localhost:9527/mcp` (or your configured port).
