...
export const methods: { [key: string]: (...any: any) => any } = {
    ...
    updateSettings(settings: MCPServerSettings) {
        ...
        if (mcpServer) {
            mcpServer.stop();
            mcpServer = new MCPServer(normalizedSettings);
            mcpServer.start();
        } else {
            mcpServer = new MCPServer(normalizedSettings);
            mcpServer.start();
    ...
    async updateToolStatus(configOrCategory: string, maybeCategory: string, maybeToolName: string | boolean, maybeEnabled?: boolean) {
        try {
    ...
    async updateToolStatusBatch(configOrUpdates: string | any[], maybeUpdates?: any[]) {
        try {
