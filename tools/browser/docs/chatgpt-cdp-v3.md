...
- `tools/browser/scripts/chatgpt_cdp_observer_v3.mjs`
  常驻 Node observer server
- `tools/browser/scripts/chatgpt_cdp_client_v3.py`
  短生命周期 Python client
- `tools/browser/scripts/chatgpt_batch_generate_v3.py`
  基于 JSON manifest 的串行批处理脚本
- `tools/browser/templates/chatgpt_batch_jobs_v3.template.json`
  V3 批处理 manifest 模版
...
```text
<当前工作目录>/workspace/output/browser/chatgpt-capture-v3-server
```
...
```text
<当前工作目录>/workspace/output/browser/chatgpt-capture-v3-client
```

## 启动 observer

```bash
node /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_cdp_observer_v3.mjs
```
...
```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_cdp_client_v3.py capture \
  --server-base http://127.0.0.1:8776 \
  --output-dir /Users/mawei/MyWork/SlgGame/workspace/output/browser/v3-test \
  --basename test-image
```
...
```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_cdp_client_v3.py generate \
  --server-base http://127.0.0.1:8776 \
  --prompt "画一个红色风筝" \
  --output-dir /Users/mawei/MyWork/SlgGame/workspace/output/browser/v3-test \
  --basename red-kite
...
```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_cdp_client_v3.py status
```

```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_cdp_client_v3.py events --limit 20
```
...
```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_batch_generate_v3.py \
  /Users/mawei/MyWork/SlgGame/tools/browser/templates/chatgpt_batch_jobs_v3.template.json
```
