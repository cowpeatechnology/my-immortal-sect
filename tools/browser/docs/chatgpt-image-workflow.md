...
- `tools/browser/scripts/chatgpt_chrome_bridge.py`
  本地桥服务与命令行入口
- `tools/browser/scripts/chatgpt_batch_generate.py`
  基于 JSON 清单的串行批量生图工具
- `tools/browser/templates/chatgpt_batch_jobs.template.json`
  JSON 批处理模版
- `tools/browser/extension/chatgpt-chrome-bridge/manifest.json`
  Chrome MV3 扩展声明
- `tools/browser/extension/chatgpt-chrome-bridge/content.js`
  页面侧自动化逻辑
- `tools/browser/extension/chatgpt-chrome-bridge/background.js`
  扩展后台逻辑，负责下载捕获等能力
- `tools/browser/extension/chatgpt-chrome-bridge/popup.html`
  扩展弹窗 UI
- `tools/browser/extension/chatgpt-chrome-bridge/popup.js`
  扩展弹窗交互逻辑
...
```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_chrome_bridge.py serve
```
...
```text
/Users/mawei/MyWork/SlgGame/tools/browser/extension/chatgpt-chrome-bridge
```
...
```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_chrome_bridge.py status
```
...
```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_chrome_bridge.py generate \
  --prompt "你的提示词" \
...
```text
/Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_batch_generate.py
```

- 模版文件：

```text
/Users/mawei/MyWork/SlgGame/tools/browser/templates/chatgpt_batch_jobs.template.json
```

### 用法

```bash
python3 /Users/mawei/MyWork/SlgGame/tools/browser/scripts/chatgpt_batch_generate.py \
  /Users/mawei/MyWork/SlgGame/tools/browser/templates/chatgpt_batch_jobs.template.json
```
...
```text
/Users/mawei/MyWork/SlgGame/workspace/output/browser/chrome-bridge/assets/batch-20260416
/Users/mawei/MyWork/SlgGame/workspace/output/browser/chrome-bridge/assets/batch-20260416/final-512
```
